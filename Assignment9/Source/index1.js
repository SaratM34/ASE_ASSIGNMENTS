...
function parseResponse(resp) {
    ...
    document.getElementById('data_bef_img').innerHTML='Given Image URL';
    document.getElementById('check').innerHTML = "<img src='"+val+"' height='200' width='300'/>";
    ...
    var hello1 = hello.toString().replace(/, /g, '%2c+');
    myGlobalVariable = hello;
    var xmlhttp = new XMLHttpRequest();
    var url = "https://api.uclassify.com/v1/prfekt/mood/Classify?readkey=rJQ6xMpDMZtD&text="+hello1;
    ...
    function myFunction(response) {
        ...
        document.getElementById("demo").innerHTML ="Happy " + obj.happy+ " " + "Upset "+ obj.upset;
    }
}

function speech(){
    var msg = new SpeechSynthesisUtterance('Tags related to the given image are'+ myGlobalVariable);
    window.speechSynthesis.speak(msg);
