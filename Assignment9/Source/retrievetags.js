...
app.get('/gettags', function (req, res) {
    ...
    request('https://api.clarifai.com/v1/tag/?url=http://wallpaper.pickywallpapers.com/2560x1600/cristiano-ronaldo-laughing.jpg&access_token=D2Jnces1D0Mu65FkHclQ9ga5tKzulC', function (error, response, body) {
        //Check for error
        if(error){
